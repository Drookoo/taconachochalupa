...
sudo nmap -A 172.20.241.0/24 -oX ../internal.xml && sudo xsltproc ../internal.xml -o ../internal.html

sudo nmap -A 172.20.240.0/24 -oX ../dmz.xml && sudo xsltproc ../dmz.xml -o ../dmz.html
